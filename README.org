...
The EWW screenshots show the default ~markdown-live-preview-mode~ path. EWW
does not evaluate the optional CSS or Mermaid.js shown in the separate browser
HTML example.
